		...
		<DialogContent>
			<form @submit.prevent="handleEdit">
				<DialogHeader>
					...
					<DialogDescription
						>Update vendor information</DialogDescription
					>
				</DialogHeader>
...
const username = ref(props.vendor.username);
const email = ref(props.vendor.email);
const password = ref("");
const errorMessage = ref("");
const profilePic = ref<FileList | null>(null);
const status = ref<FetchStatus>("idle");
const originalValues = ref({
	username: props.vendor.username,
...
watch(
	() => props.vendor,
	(newVendor) => {
		username.value = newVendor.username;
		email.value = newVendor.email;
		password.value = "";
		errorMessage.value = "";
...
const handleEdit = async () => {
	...
	try {
		...
		errorMessage.value = error.message || "Failed to update vendor";
		status.value = "idle";
	}
};
</script>
